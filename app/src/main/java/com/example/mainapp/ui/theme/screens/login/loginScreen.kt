package com.example.mainapp.ui.theme.screens.login
...
import com.example.mainapp.navigation.ROUTE_REGISTER
...
fun loginScreen(navController: NavController){
    ...
    Column(modifier = Modifier.fillMaxSize(), verticalArrangement = Arrangement.Center, horizontalAlignment = Alignment.CenterHorizontally) {
        ...
        Image(painter = painterResource(id = R.drawable.logo), contentDescription = "Image logo", modifier = Modifier.fillMaxWidth().height(80.dp), contentScale = ContentScale.Fit)
